build:
	...
	cc -c -g -O0 -Wall -pedantic -Wno-unused-but-set-variable -Wno-gnu-anonymous-struct -Wno-nested-anon-types antiqua/antiqua.m -o m.o
	# Compile all C++ files
	cc -c -g -O0 -std=c++17 -Wall -pedantic -Wno-unused-but-set-variable -Wno-gnu-anonymous-struct -Wno-nested-anon-types antiqua/antiqua.cpp -o cpp.o
	# Link
